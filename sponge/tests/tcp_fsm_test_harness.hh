...
//! man7::unix), for use by TCPTestHarness
//! \details A TestFD comprises the two endpoints of a Unix-domain socket
//! connection. The contents of a write() to this object can subsequently be
//! read() from it.
