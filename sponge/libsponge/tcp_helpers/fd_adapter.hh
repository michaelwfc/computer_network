...
//! \details See TCPOverUDPSocketAdapter and TCPOverIPv4OverTunFdAdapter for
//! more information.
class FdAdapterBase {
private:
...
public:
  ...
  //! Attempts to read and return a TCP segment related to the current
  //! connection from a UDP payload
